...
try:
    user_input = int(input("Введите количество пословиц (до 25): "))
except ValueError:
    print("Введено не число. Программа завершается.")
else:
    for item in range(user_input):
        ...
        print(f"{item + 1}. {random_proverb.replace('Ум', random_variant)}")# так красивее
        # result.append(random_proverb.replace('Ум', random_variant))
# print(result)